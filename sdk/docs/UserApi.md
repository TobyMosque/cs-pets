...
> User CreateUsersWithListInput (Collection<User>? user = null)
...
namespace Example
{
    public class CreateUsersWithListInputExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new UserApi(httpClient, config, httpClientHandler);
            var user = new Collection<User>?(); // Collection<User>? |  (optional) 
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **user** | [**Collection&lt;User&gt;?**](User.md) |  | [optional]  |
