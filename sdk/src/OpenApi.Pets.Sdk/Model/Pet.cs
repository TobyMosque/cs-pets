...
namespace OpenApi.Pets.Sdk.Model
{
    ...
    public partial class Pet : IEquatable<Pet>, IValidatableObject
    {
        ...
        public Pet(long id = default(long), string name = default(string), Category category = default(Category), Collection<string> photoUrls = default(Collection<string>), Collection<Tag> tags = default(Collection<Tag>), StatusEnum? status = default(StatusEnum?))
        {
        ...
        public Collection<string> PhotoUrls { get; set; }
